...
public class UList2 {
    ...
    public static List<String> getList() {
        List<String> parentList = PList2.getList();
        ...
        for(int j = 1; j< parentList.size() -3;j++){
        ...
        urlList.add(parentList.get(parentList.size()-3));
        urlList.add(parentList.get(parentList.size()-2));
