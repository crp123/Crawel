...
public class MagicSingleMap {
    public static HashMap<String,String> getMagicSingleMap(String mFileName){
        String r = null;
        String[] a = null;
        ...
        try {
            try {
                magicsingleFIS = new FileInputStream("D:\\crawler\\magicsingle\\"+mFileName+".txt");
